  ...
  <section class="learn">
    <div class="grid-container">
      ...
      <div class="grid-item left-column">
        <h1>LEARN <span>NUVOLARIS</span></h1>
        <p>
          Nuvolaris is <strong>extremely<br>easy to use:</strong> in a week<br>
          you will be able to<br>master it!
        </p>
      </div>

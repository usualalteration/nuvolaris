  ...
  const products = [
    {
      ...
      title: "DEVELOPMENT",
      category: "NUVOLARIS",
      image: "img/icona-monitor.png",
      color: "#F4A261",
      event: "switchToDevelopment",
      textClass: "grey"
    },
    {
      id: "production",
      title: "PRODUCTION",
      category: "NUVOLARIS",
      image: "img/icona-enterprise.png",
      color: "#E76F51",
      event: "switchToProduction",
      textClass: ""
    },
    {
      id: "premises",
      title: "ON PREMISES",
      category: "NUVOLARIS",
      image: "img/Livello_1.png",
      color: "#0077B6",
      event: "switchToOnPremises",
      textClass: ""
    }
  ];
</script>
    ...
    <div class="three-columns">
      ...
      <div class="product-grid">
        <div class="threeproducts">
          ...
          <p id="white" class="right-text verybigletters">
            P<span>R</span>OD
          </p>
          <p id="white" class="right-text verybigletters">
            UC<span>T</span>S
        ...
        {#each products as product}
          <div id="{product.id}" class="product-card">
            ...
            <a
              ...
              on:click={() => dispatch(product.event)}
            >
              LEARN MORE
            </a>
          </div>
  ...
  <div class="benefits-container">
    ...
    <div class="benefit benefits2">
      ...
      <div>
        <h4>SIMPLICITY</h4>
        <p>
          • Deploy applications easily<br />
          • No need for code migration
        </p>
      </div>
    </div>
